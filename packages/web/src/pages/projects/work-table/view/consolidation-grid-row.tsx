      ...
      {FROZEN_COLS.map((col, index) => {
        ...
        return (
          <td
            key={col.key}
            className={cn(
              'border-b border-row-divider px-1 py-1 text-right text-xs font-mono tabular-nums',
              rowBg,
              index === 7 || index === 13 ? 'border-r-2 border-r-row-divider' : index === 3 || index === 6 || index === 10 || index === 12 ? 'border-r-2 border-r-row-divider' : 'border-r border-r-row-divider',
